...
function Modal(invitingUserName, loggedUserName, socket) {
  var modal = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.createElement)('div', {}, [document.createTextNode("".concat(invitingUserName, " esta te chamando para a jogar")), (0,_utils__WEBPACK_IMPORTED_MODULE_0__.createElement)('button', {
    innerText: 'Aceitar',
...
function receiveNotification(connection) {
  connection.socket.on('newInvite', function (_ref) {
    ...
    if (!connection.username) return;
    var body = document.getElementById('notification');
    if (!body) return;
