...
var victory = () => {
    if (
        square[0].value == square[1].value &&
        square[1].value == square[2].value &&
        square[0].value != '_'
    ) {
        ...
        square[3].value == square[4].value &&
        square[4].value == square[5].value &&
        square[3].value != '_'
    ) {
        ...
        square[6].value == square[7].value &&
        square[7].value == square[8].value &&
        square[6].value != '_'
    ) {
        ...
        square[0].value == square[3].value &&
        square[3].value == square[6].value &&
        square[0].value != '_'
    ) {
        square[0].style.backgroundColor = '#0F0';
        square[3].style.backgroundColor = '#0F0';
        ...
        square[1].value == square[4].value &&
        square[4].value == square[7].value &&
        square[1].value != '_'
    ) {
        square[1].style.backgroundColor = '#0F0';
        square[4].style.backgroundColor = '#0F0';
        ...
        square[2].value == square[5].value &&
        square[5].value == square[8].value &&
        square[2].value != '_'
    ) {
        square[2].style.backgroundColor = '#0F0';
        square[5].style.backgroundColor = '#0F0';
        ...
        square[0].value == square[4].value &&
        square[4].value == square[8].value &&
        square[0].value != '_'
    ) {
        square[0].style.backgroundColor = '#0F0';
        square[4].style.backgroundColor = '#0F0';
        ...
        square[2].value == square[4].value &&
        square[4].value == square[6].value &&
        square[2].value != '_'
    ) {
        square[2].style.backgroundColor = '#0F0';
        square[4].style.backgroundColor = '#0F0';
